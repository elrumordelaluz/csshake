...
<p><strong>And remember that there isn't <strong>-prefixes</strong> on the main code</strong>. Hoping that one day we won't need it.<br>In the <a href="http://elrumordelaluz.github.io/csshake/">demo page</a> I use the magic <a href="http://leaverou.github.io/prefixfree/">prefixfree</a></p>
